...
const GlobalConfig = {
  ...
  IS_PRODUCTION:
    getEnvironmentString('NODE_ENV', 'development') === 'production',
...
const DatabaseConfig = {
  ...
  DB_USER: getEnvironmentString('DB_USER', 'postgres'),
  DB_PASSWORD: getEnvironmentString('DB_PASSWORD', 'postgres'),
  DB_NAME: getEnvironmentString('DB_NAME', 'postgres'),
};
